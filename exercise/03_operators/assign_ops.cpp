...
int main() {
    ...
    // TODO: Replace with correct assignment logic.
    int a, b, c;
    // a = b = c = ??;
...
/*
Expected Output:
Task 1 -> a = b = c = 10; All should print 10
Task 2 -> score = 30
Task 3 -> num = 16
Task 4 -> x = 7, y = 3
Task 5 -> result = 30
